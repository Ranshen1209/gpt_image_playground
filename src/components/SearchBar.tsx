    ...
    <div ref={rootRef} data-no-drag-select className="mt-6 mb-4 flex gap-3">
      <div className="flex gap-2 flex-shrink-0 z-20">
        ...
        {inCollectionOverview && (
          <SearchActionButton
            ...
            className="p-2.5 rounded-xl border border-white/60 dark:border-white/[0.08] bg-white/70 dark:bg-white/[0.04] text-gray-400 hover:bg-white dark:hover:bg-white/[0.08] transition-all"
          >
            ...
            <div className="relative w-[88px]">
              <Select
                ...
                options={[
                  ...
                  { label: t('search.filterDone'), value: 'done' },
                  { label: t('search.filterRunning'), value: 'running' },
                  { label: t('search.filterError'), value: 'error' },
                ]}
                className="px-3 py-2.5 rounded-xl border border-white/60 dark:border-white/[0.08] bg-white/70 dark:bg-white/[0.04] hover:bg-white dark:hover:bg-white/[0.08] text-sm focus:outline-none focus:ring-2 focus:ring-[#9181bd]/30 focus:border-[#9181bd] transition"
              />
            </div>
            {isFailedFilter && (
              <button
                ...
                className="flex h-[42px] w-[42px] shrink-0 items-center justify-center rounded-xl border border-white/60 bg-white/70 text-gray-400 transition-all hover:bg-white hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#9181bd]/30 disabled:cursor-not-allowed disabled:opacity-55 disabled:hover:bg-white/70 disabled:hover:text-gray-400 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-gray-500 dark:hover:bg-white/[0.08] dark:hover:text-gray-300 dark:disabled:hover:bg-white/[0.04] dark:disabled:hover:text-gray-500"
              >
      ...
      <div className="relative z-10 flex-1">
        ...
        <input
          ...
          type="text"
          placeholder={inCollectionOverview ? '搜索收藏夹名称...' : t('search.placeholder')}
          className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-white/60 dark:border-white/[0.08] bg-white/70 dark:bg-white/[0.04] text-sm focus:outline-none focus:ring-2 focus:ring-[#9181bd]/30 focus:border-[#9181bd] transition"
        />
      </div>
    </div>
  )
