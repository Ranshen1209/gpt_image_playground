...
export async function callBatchImageSingle(opts: {
  ...
  const { profile, allProfiles, params, batchItemId, prompt, referenceImageDataUrls, referenceIds, allowPromptRewrite, signal, onImageToolStarted, onPartialImage, onImageToolCompleted } = opts
