...
describe('beginLogin', () => {
  it('writes PKCE artifacts and navigates to /oauth/authorize with required params', async () => {
    ...
    expect(params.get('scope')).toBe('profile:read account:read account:balance:read models:read images:create responses:create chat.completions:create offline_access')
  })
})
