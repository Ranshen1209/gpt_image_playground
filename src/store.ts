...
export function showCodexCliPrompt(force = false, reason = i18n.t('errors.codexCliReasonRewritten')) {
  ...
  state.setConfirmDialog({
    ...
    message: i18n.t('errors.codexCliMessage', { reason }),
...
async function executeAgentRound(
  ...
  try {
    ...
    const ensureStreamingAgentTask = async (
      ...
      options: { createdAt?: number; agentBatchCallId?: string; maskTargetImageId?: string | null; maskImageId?: string | null; apiProfile?: ApiProfile | null } = {},
    ) => {
